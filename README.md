...
Analyze the Bank Marketing dataset to:
- Understand customer demographics and campaign behavior
- Explore relationships between key variables
- Preprocess data for model readiness
- Train and evaluate a predictive model for deposit subscription
...
- Distribution of customers by age, job type, marital status, and education
- Campaign-related patterns such as call duration and contact frequency
...
This project demonstrates how demographic factors, call duration, and past campaign outcomes influence a client’s likelihood to subscribe to a term deposit. The combination of EDA, preprocessing, and machine learning provides a clear understanding of customer behavior and campaign success patterns.
